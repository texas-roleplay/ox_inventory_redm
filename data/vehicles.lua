	...
	return {
		...
		trunk = {
			models = {
				...
				[`CART07`] 				= {11, 80000},   --    
				[`CART08`] 				= {11, 80000},   --  
				[`ARMYSUPPLYWAGON`] 	= {11, 80000},   --   
				[`BUGGY01`] 			= {11, 80000},   -- 
				[`BUGGY02`] 			= {11, 80000},   -- 
				[`BUGGY03`] 			= {11, 80000},   -- 
				[`CHUCKWAGON000X`] 		= {11, 80000},   --  
				[`CHUCKWAGON002X`] 		= {11, 80000},   --  
				[`COACH2`] 				= {11, 80000},   --  
				[`COACH3`] 				= {11, 80000},   --  
				[`COACH4`] 				= {11, 80000},   --    
				[`COACH5`] 				= {11, 80000},   -- 
				[`COACH6`] 				= {11, 80000},   -- 
				[`coal_wagon`] 			= {11, 80000},   --  
				[`OILWAGON01X`] 		= {11, 80000},   -- 
				[`POLICEWAGON01X`] 		= {11, 80000},   -- 
				[`WAGON02X`] 			= {11, 80000},   --  
				[`WAGON04X`] 			= {11, 80000},   --  
				[`LOGWAGON`] 			= {11, 80000},   -- 
				[`WAGON03X`] 			= {11, 80000},   -- 
				[`WAGON05X`] 			= {11, 80000},   -- 
				[`WAGON06X`] 			= {11, 80000},   --  
				[`WAGONPRISON01X`] 		= {11, 80000},   --  
				[`STAGECOACH001X`] 		= {11, 80000},   --  
				[`STAGECOACH002X`] 		= {11, 80000},   --  
				[`STAGECOACH003X`] 		= {11, 80000},   --  
				[`STAGECOACH004X`] 		= {11, 80000},   -- 
				[`STAGECOACH005X`] 		= {11, 80000},   --  
				[`STAGECOACH006X`] 		= {11, 80000},   -- 
				[`UTILLIWAG`] 			= {11, 80000},   --   
				[`GATCHUCK`] 			= {11, 80000},   --    
				[`GATCHUCK_2`] 			= {11, 80000},   --  
				[`wagonCircus01x`] 		= {11, 80000},   -- 
				[`wagonDairy01x`] 		= {11, 80000},   --   
				[`wagonWork01x`] 		= {11, 80000},   --  
				[`wagonTraveller01x`] 	= {11, 80000},   -- 
				[`supplywagon`] 		= {11, 80000},   -- 
			},
			boneIndex = {
				[`pounder`] = 'wheel_rr'
			}
